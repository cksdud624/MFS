...
namespace InGame.Component.Controller
{
    public class ControllerPlayer : ControllerBase
    {
        ...
        private void OnAttack(InputAction.CallbackContext context) => ObjectContext.PlayEffect(EffectType.Attack, ObjectContext.Direction == Direction.Right ? Vector2.right : Vector2.left);
        #endregion
